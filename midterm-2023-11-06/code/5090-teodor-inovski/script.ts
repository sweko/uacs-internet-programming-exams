...
const formedSorter: BandSorter=(first,second)=> first.formed - second.formed;
const locationSorter: BandSorter=(first,second)=> first.location.localeCompare(second.location);
const albumSorter: BandSorter=(first,second)=> first.albums.length-second.albums.length;
const memberSorter: BandSorter=(first,second)=> first.members.length- second.members.length
