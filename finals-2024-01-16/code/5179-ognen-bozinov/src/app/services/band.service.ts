...
export class BandsService {
    ...
    getCitiesForCountry(country: string): Observable<string[]> {
      ...
      getBandsPerGenre(): Observable<any> {
        return this.http.get<any>(`${BASE_URL}/bands-per-genre`);
      }
    
      getAlbumsPerGenre(): Observable<any> {
        return this.http.get<any>(`${BASE_URL}/albums-per-genre`);
      }
    
      getAlbumsPerDecade(): Observable<any> {
        return this.http.get<any>(`${BASE_URL}/albums-per-decade`);
      }
